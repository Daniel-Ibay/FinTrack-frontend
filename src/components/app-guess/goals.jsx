...
const Goals = () => {
  const goals = useGuessStore((state) => state.goals);
  const addGoal = useGuessStore((state) => state.addGoal);
  const removeGoal = useGuessStore((state) => state.removeGoal);
  ...
  const handleAddGoal = (e) => {
    ...
    addGoal(Goal);
    e.target.amount.value = undefined;
